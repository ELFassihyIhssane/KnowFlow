...
"[project]/node_modules/react-cytoscapejs/dist/react-cytoscape.modern.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const { string: o, array: l, object: s, number: a, bool: i, oneOfType: r, any: c, func: u } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], d = {
    id: o,
    className: o,
    style: r([
        o,
    ...
    const n = Object.keys(e), o = Object.keys(t), l = (n)=>e[n] !== t[n];
    return n.length !== o.length || !(!n.some(l) && !o.some(l));
}, m = (e, t)=>null != e ? e[t] : null, y = {
    diff: p,
    get: m,
    toJson: (e)=>e,
...
}, h = (e, t, n, o)=>n(m(e, o), m(t, o)), b = (e, t, n, o, l, s, a)=>{
    e.batch(()=>{
        (o === p || h(t, n, o, "elements")) && x(e, m(t, "elements"), m(n, "elements"), l, s, a, o), h(t, n, o, "stylesheet") && E(e, m(t, "stylesheet"), m(n, "stylesheet"), l), [
            "zoom",
            "minZoom",
            "maxZoom",
            "zoomingEnabled",
    ...
    const i = [], r = e.collection(), c = [], u = {}, d = {}, p = (e)=>l(l(e, "data"), "id");
    s(n, (e)=>{
        const t = p(e);
        d[t] = e;
    }), null != t && s(t, (t)=>{
        ...
        const t = p(e), n = ((e)=>u[e])(t);
        ((e)=>null != u[e])(t) ? c.push({
            ele1: n,
            ele2: e
        }) : i.push(o(e));
    }), r.length > 0 && e.remove(r), i.length > 0 && e.add(i), c.forEach(({ ele1: t, ele2: n })=>O(e, t, n, o, l, a));
}, O = (e, t, n, o, l, s)=>{
    const a = l(l(n, "data"), "id"), i = e.getElementById(a), r = {};
    [
        "data",
        "position",
        "selected",
...
class w extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].Component {
    ...
    static normalizeElements(e) {
        ...
        {
            let { nodes: t, edges: n } = e;
            return null == t && (t = []), null == n && (n = []), t.concat(n);
        }
    }
    constructor(t){
        super(t), this.displayName = "CytoscapeComponent", this.containerRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createRef();
    }
    componentDidMount() {
        const e = this.containerRef.current, { global: t, headless: o, styleEnabled: l, hideEdgesOnViewport: s, textureOnViewport: a, motionBlur: i, motionBlurOpacity: r, wheelSensitivity: c, pixelRatio: u } = this.props, d = this._cy = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cytoscape$2f$dist$2f$cytoscape$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]({
            container: e,
            headless: o,
            styleEnabled: l,
    ...
    updateCytoscape(e, t) {
        const n = this._cy, { diff: o, toJson: l, get: s, forEach: a } = t;
    ...
    render() {
        const { id: t, className: n, style: o } = this.props;
...
//# sourceMappingURL=node_modules_8dfb1c04._.js.map